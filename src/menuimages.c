...
void menu_draw_image (_menuitem *mi)
{
  ...
  gfx_blit ((SDL_Surface *) mi->ptrdata, &src, gfx.screen, &dest,
            10000+mi->pos.w);
};


_menuitem *menu_create_image (_menu *menu, char *name, int x, int y, int layer,
                              SDL_Surface *img, SDL_Rect *rect)
{
