...
scale_image (SDL_Surface *orginal, int newx, int newy)
{
  ...
  surface = SDL_CreateRGBSurface (SDL_HWSURFACE, newx, newy, 32, rmask, gmask,
                                  bmask, amask);
  if (surface == NULL)
    {
...
makegray_image (SDL_Surface * org)
{
  ...
  dest = SDL_CreateRGBSurface (SDL_SWSURFACE, org->w, org->h,
                               org->format->BitsPerPixel,
...
SDL_Surface *
gfx_quater_image (SDL_Surface * org1, SDL_Surface * org2, SDL_Surface * org3,
                  SDL_Surface * org4)
{
  Uint32 pixel;
  SDL_Surface *dest;
  ...
  dest = SDL_CreateRGBSurface (SDL_HWSURFACE, org1->w, org1->h,
                               org1->format->BitsPerPixel,
