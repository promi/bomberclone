...
extern void do_getplayerdata (struct pkg_getplayerdata *gp_dat,
                              _net_addr *addr);
...
extern void send_playerid (_net_addr *addr, char *name, char *pladdr,
                           char *plport, int p_nr, int gfx_nr, int team_nr, signed char netflags);
...
extern void send_playerstatus (_net_addr *addr, int pl_nr, int net_istep,
                               int status);
...
extern int rscache_del (_net_addr *addr, unsigned char typ,
